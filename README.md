...
- Modify `src/genericsuite_asdt/config/agents.yaml` to define your agents
- Modify `src/genericsuite_asdt/config/tasks.yaml` to define your tasks
- Modify `src/genericsuite_asdt/crew.py` to add your own logic, tools and specific args
- Modify `src/genericsuite_asdt/main.py` to add custom inputs for your agents and tasks
