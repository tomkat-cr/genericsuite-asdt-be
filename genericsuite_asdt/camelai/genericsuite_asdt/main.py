...
def get_configured_crew():
    ...
    """
    use_generic_crew = \
        os.environ.get('CAMELI_USE_GENERIC_CREW', "true") == "true"
    _ = DEBUG and log_debug(
        f"Camel-AI Get Configured Crew | Params: {use_generic_crew}")
    if use_generic_crew:
...
def run(project: str = None, topic: str = None):
    ...
    if inputs['error']:
        ...
        return
    # _ = DEBUG and log_debug(f"Camel-AI Run | Inputs: {inputs}")
...
def stream_run(project: str = None, topic: str = None):
    ...
    if inputs['error']:
        log_error(inputs['error_message'])
        return
    _ = DEBUG and log_debug(f"Camel-AI stream_run | Inputs: {inputs}")
...
def train(project: str = None, topic: str = None):
    ...
    _ = DEBUG and log_debug(f"Camel-AI Train | Inputs: {inputs}" +
...
def replay():
    ...
    _ = DEBUG and log_debug(f"Camel-AI Train | task_id: {task_id}")
    try:
        crew = get_configured_crew()
